    ...
    xhr.onreadystatechange = function (){
      if(this.readyState == 4 && this.status == 200){
        ...
        if(r.stream != null && (on || all)){  
          ...
          var xhr = new XMLHttpRequest();
          xhr.open("GET", "https://wind-bow.glitch.me/twitch-api/channels/" + link, true);
...
$(document).ready(function(){
  ...
  search(a, true, false, false);


  $('#online').click(function(){
    search(a, false, true, false)
  });

  $('#offline').click(function(){
    search(a, false, false, true);
  });
